...
\def\grad{\nabla}
\def\del{\partial}
\DeclareMathOperator{\Neighbors}{\texttt{N}}
\DeclareMathOperator{\Succ}{\texttt{S}}
\DeclareMathOperator{\Pred}{\texttt{P}}
\DeclareMathOperator{\Value}{\texttt{V}}
\DeclareMathOperator{\mycolor}{\texttt{color}}
